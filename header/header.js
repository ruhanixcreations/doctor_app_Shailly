...
function applyRoleBasedVisibility() {
  ...
  console.log('🔍 LocalStorage role value:', localStorage.getItem('role'));
  ...
  setTimeout(() => {
    ...
    console.log('🔍 Menu items found:', {
      ...
      addPrescription: !!addPrescriptionLink,
      addPatient: !!addPatientLink,
    ...
    if (role === 'receptionalist') {
      console.log('✅ RECEPTIONALIST ROLE - Hiding non-receptionist menu items');
...
function hideMenuItem(linkElement) {
  if (!linkElement) {
    console.log('⚠️ hideMenuItem called with null/undefined element');
    return;
  }
  ...
  if (menuItem) {
    ...
    console.log('🚫 Hiding menu item:', menuText);
    menuItem.style.display = 'none';
    menuItem.setAttribute('aria-hidden', 'true');
  } else {
    console.log('⚠️ Could not find parent .menu-item for link');
  }
}
